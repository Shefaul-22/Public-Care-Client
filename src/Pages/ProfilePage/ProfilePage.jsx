...
const ProfilePage = () => {
    ...
    return (
        <div className=' py-6'>
            <div className=" shadow-lg rounded-2xl  text-base-content p-12">

                <h2 className='text-2xl  md:text-5xl text-base-content font-bold mb-4'>Your <span className='text-[#fa0bd2]'>Profile</span></h2>
        ...
        w-64 bg-gray-900 text-base-content text-xs rounded-md px-3 py-2
        ...
        pointer-events-none text-center shadow-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="p-4 bg-gray-100 rounded-xl">
                        <h3 className="text-sm font-semibold text-gray-900 ">UID</h3>
                    ...
                    <div className="p-4 bg-gray-100 rounded-xl">
                        <h3 className="text-sm font-semibold text-gray-900">UID Provider</h3>
                        <p className="mt-1 text-gray-900 text-sm">{user.providerId}</p>
                    </div>

                    <div className="p-4 bg-gray-100 rounded-xl">
                        <h3 className="text-sm font-semibold text-gray-900">Last Sign-In</h3>
